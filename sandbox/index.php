...
<div class="container" style="margin-top: 60px;"> <!-- Added margin for fixed navbar -->
    <div class="row">
        <div class="col-md-4 col-md-offset-4 col-xs-12"> <!-- Added col-xs-12 for mobile responsiveness -->
            <div class="login-con">
                <?php
                ...
                <form method="post" action="process/login.php" role="form">
                    ...
                    <div class="form-group">
                        <input type="submit" name="submit" value="Submit" class="btn btn-danger btn-block"> <!-- btn-block for full-width button -->
                    </div>
                </form>
            </div>
        </div>
