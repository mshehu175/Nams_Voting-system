...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php">NAMS Voting Sytem</a>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            ?>
                ...
                <h4><?php echo $org; ?> <b>Election Results</b></h4>
                <hr>
                ...
                <?php if($rtnReadPos) { ?>
                    ...
                    $winner = null;
                    $maxVotes = -1; // Initialize with a negative number to start vote comparison
                    ?>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-condensed table-striped">
                            ...
                            <?php while($rowCountVotes = $rtnReadNomOrgPos->fetch_assoc()) { ?>
                                <?php
                                // Get the number of votes for this nominee
                                $countVotes = new Nominees();
                                $rtnCountVotes = $countVotes->COUNT_VOTES($rowCountVotes['id']);
                                $numVotes = $rtnCountVotes->num_rows;

                                // Determine the nominee with the highest votes
                                if ($numVotes > $maxVotes) {
                                    $maxVotes = $numVotes;
                                    $winner = $rowCountVotes; // Store the nominee's details
                                }
                                ?>
                                <tr>
                                    <td style="width: 20%;"><?php echo $rowCountVotes['stud_id']; ?></td>
                                    <td style="width: 70%;"><?php echo $rowCountVotes['name']; ?></td>
                                    <td style="width: 10%;"><?php echo $numVotes; ?></td>
                                </tr>
                            <?php } // End while ?>
                        </table>
                    ...
                    <?php if ($winner) { ?>
                        <div class="alert alert-success">
                            <strong>Winner for <?php echo $rowPos['pos']; ?>: </strong> 
                            <?php echo $winner['name']; ?> with <?php echo $maxVotes; ?> votes!
                        </div>
                    <?php } ?>
